...
import { useAdminSingleProductInvoice } from "@/lib/react-query/hooks";
import {
  Table,
  TableBody,
  TableCell,
...
const AdminSingleProductInvoice = ({ invoiceId }: { invoiceId: string }) => {
...
export default AdminSingleProductInvoice;
