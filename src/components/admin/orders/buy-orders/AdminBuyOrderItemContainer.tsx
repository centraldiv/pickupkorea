import type { BuyOrderWithItemsAndAddress } from "@/lib/react-query/hooks";
import { getWebsiteNames } from "@/lib/utils";
import { format } from "date-fns";
import { ko } from "date-fns/locale/ko";

const AdminBuyOrderItemContainer = ({
  order,
}: {
  order: BuyOrderWithItemsAndAddress;
}) => {
...
export default AdminBuyOrderItemContainer;
