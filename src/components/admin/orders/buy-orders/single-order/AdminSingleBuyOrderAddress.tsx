...
import {
  PrivateQueryKeys,
  updateAdminBuyOrderAddress,
} from "@/lib/react-query/config";

const AdminSingleBuyOrderAddress = ({ orderId }: { orderId: string }) => {
  ...
  const mutation = useMutation(
    {
      ...
      mutationFn: async (values: z.infer<typeof OrderAddressSchema>) => {
        return await updateAdminBuyOrderAddress(values);
      },
...
export default AdminSingleBuyOrderAddress;
